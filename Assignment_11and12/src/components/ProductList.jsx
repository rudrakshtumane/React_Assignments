...
const products = [
  { prodID: 1, pName: 'Casino tourbillon', image: 'https://cdn1.ethoswatches.com/media/catalog/product/cache/06b0325fe0d1ea074c67035fe5935845/j/a/jacob-co-casino-tourbillon-ca100-40-aa-aa-abala_1.jpg' },
    ...
    <div className="container w-full p-4 bg-white">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 m-5">
        {products.map((product) => (
          <div className="card card-compact shadow-xl m-5" key={product.prodID}>
            ...
            <div className="card-body">
              <Link to={`/product/${product.prodID}`} className="text-black text-2xl">
                {product.pName}
              </Link>
              <Link to={`/product/${product.prodID}`} className="text-blue-500">
                View Details
              </Link>
            </div>
          </div>
